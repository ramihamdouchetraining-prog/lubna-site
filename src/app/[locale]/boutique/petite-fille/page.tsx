...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const items = await getProductsByCategory(locale || 'fr', 'petite-fille');
  return (
    <div>
      <h1 className="text-2xl font-semibold mb-6">Petite fille musulmane</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {items.map((p) => {
            const img =
              ...
              'https://epefjqrxjbpcasygwywh.supabase.co/storage/v1/object/public/assets-public/hero7.png';
            return (
